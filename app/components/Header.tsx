    ...
    <>
      <nav className="fixed top-0 w-full z-50 bg-[#2D5C64]/95 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 py-4">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-4 py-4 flex flex-col gap-4 border-t border-white/10">
              ...
              <a href="https://app.botrural.app/login" className="bg-[#02C951] text-white px-6 py-2.5 rounded-lg font-semibold text-center" onClick={() => setMobileMenuOpen(false)}>Ingresar</a>
            </div>
          )}
        </div>
      </nav>
